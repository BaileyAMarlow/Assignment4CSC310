...
FOR BINARYTREE:
	To run this program, enter your values for the binary tree in the list named tree, being sure to input a 
"None" in every empty slot of the binary tree given what level of the tree you are on.
